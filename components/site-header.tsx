...
{/* Announcement Bar */} <div className="relative overflow-hidden bg-gradient-to-r from-[#2563EB] via-[#38BDF8] to-[#06B6D4] text-white"> <div className="mx-auto flex max-w-7xl items-center justify-center gap-3 px-4 py-2 text-center text-xs font-medium sm:text-sm"> <Rocket className="hidden size-4 shrink-0 sm:block" />
